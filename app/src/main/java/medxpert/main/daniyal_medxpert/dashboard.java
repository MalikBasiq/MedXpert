...
//        //TODO handling on click listener for each imagebutton:
        CardView medicalRecordCardView = findViewById(R.id.medicalRecordBtn);
        CardView remindersCardView = findViewById(R.id.remindersBtn);
        CardView medBoxCardView = findViewById(R.id.medBoxBtn);
        CardView labTestsCardView = findViewById(R.id.labTestBtn);
        medicalRecordCardView.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        medBoxCardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(dashboard.this, "Medbox clicked", Toast.LENGTH_SHORT).show();
            }
        });

        labTestsCardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(dashboard.this, "Lab Tests clicked", Toast.LENGTH_SHORT).show();
            }
        });
...
//
//
//        ImageButton Lab_Test = findViewById(R.id.labTestBtn);
